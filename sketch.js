...
function setup() {
	...
	box2Sprite=createSprite(290,560,20,200);
	box2Sprite.shapeColor=color(255,0,0)

	box3Sprite=createSprite(490,560,20,200);
	...
	box2=Bodies.rectangle(290,560,20,200,{isStatic:true});
	World.add(world,box2);

	box3=Bodies.rectangle(490,560,20,200,{isStatic:true});
	World.add(world,box2);
